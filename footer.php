    ...
    <!-- Chart JS -->
    <script src="<?php echo asset("assets/js/morris.js") ?>"></script>

    <script src="<?php echo asset("assets/plugins/raphael/raphael.min.js") ?>"></script>
    <script src="<?php echo asset("assets/js/chart.js") ?>"></script>
    <script src="<?php echo asset("assets/js/linebar.min.js") ?>"></script>
    <script src="<?php echo asset("assets/js/piechart.js") ?>"></script>
    <script src="<?php echo asset("assets/js/apex.min.js") ?>"></script>
